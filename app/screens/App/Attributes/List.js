...
import { loadList, setID, removeCategory } from "../../../actions/attributes"
      ...
      <React.Fragment>
        <View style={redesign.Containers.screenContainer}>
          ...
          <ScrollView style={{ padding: 10, marginBottom: 30 }} refreshControl={<RefreshControl refreshing={this.state.dataLoading} onRefresh={this.loadList} />}>
            {this.props && this.props.attributes && this.props.attributes.attributes && this.props.attributes.attributes.map((element, index) => (
